...
import com.example.katalogsmarthpone.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    simple.example.kamussasak.Adapter adapter;
    ...
    private void setupListview() {
        adapter = new simple.example.kamussasak.Adapter(this, daftarTransaksi);
    ...
    private void bukaFormTambahTransaksi() {
        Intent intent = new Intent(this, simple.example.kamussasak.Activity.class);
